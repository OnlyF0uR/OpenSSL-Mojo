...
fn sha224(input: String) raises -> String:
  ...
  var result = external_call["sha224", Pointer[UInt8], Pointer[UInt8], Int32](param_a, param_b)
  var s_result = c_charptr_to_string(result, 56)
...
fn sha224_file(file_path: String) raises -> String:
  # TODO: Check if file actually exists instead of just letting it fail
  var param_a = to_char_ptr(file_path)

  var result = external_call["sha224_file", Pointer[UInt8], Pointer[UInt8]](param_a)
  var s_result = c_charptr_to_string(result, 56)
...
fn sha384(input: String) raises -> String:
  var param_a = to_char_ptr(input)
  var param_b = len(input)

  var result = external_call["sha384", Pointer[UInt8], Pointer[UInt8], Int32](param_a, param_b)
  var s_result = c_charptr_to_string(result, 96)
...
fn sha384_file(file_path: String) raises -> String:
  # TODO: Check if file actually exists instead of just letting it fail
  var param_a = to_char_ptr(file_path)

  var result = external_call["sha384_file", Pointer[UInt8], Pointer[UInt8]](param_a)
  var s_result = c_charptr_to_string(result, 96)
